...
$log = Join-Path -Path $PSScriptRoot -ChildPath "..\streamlit_ui_capture.log"
...
$outLog = Join-Path -Path $PSScriptRoot -ChildPath "..\streamlit_stdout.log"
$errLog = Join-Path -Path $PSScriptRoot -ChildPath "..\streamlit_stderr.log"
